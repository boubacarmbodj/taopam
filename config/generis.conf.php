...
# local namespace
define('LOCAL_NAMESPACE','http://localhost:81/taopam/PAM.rdf');

# platform identification
define('GENERIS_INSTANCE_NAME','PAM');
define('GENERIS_SESSION_NAME','tao_GyH9deSx');

# paths
define('ROOT_PATH','C:\\xampp\\htdocs\\taopam\\');
define('ROOT_URL','http://localhost:81/taopam/');
...
define('FILES_PATH','C:\\xampp\\htdocs\\taopam\\data\\');
